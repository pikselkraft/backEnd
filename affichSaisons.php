	...
	switch ($actionSaison) 
	{
		...
		case "SAM": // ajout de tous les samedis pour une ann�e
			if(!empty($_POST["annee"]))
			{
				...
				//on regarde la date de fin d'ann�e demand�e
				...
				while ($date_test<$date_final) // tant que l'on parcourt les dates de l'ann�e en cours
				{
					if (typeSaison(strtotime($date_test))) // on teste si la date n'est pas d�j� inclue dans une saison d�j� pr�sente
					{
					...
					//on incr�mente pour parcourir l'ann�ee
...
//Boucle qui parcourt les saisons dans la base de donn�es
