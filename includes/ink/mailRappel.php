...
function envoiRappel($email) // fonction qui g&eacute;n&eacute;re un nouveau mot de passe
{
	global $mysqli;
	if(isset($email)) {
		 ...
		 */
		 ...
		 if ($row=$result->fetch_Assoc()) {
			...
			TemplateRappel($email, "Gite LeMetzval - Le rappel de facture pour votre reservation",$pdf,$civilite,$nom,$prenom);
			return $pdf;
		 }
		 else
		 {
...
function TemplateRappel($destinataire,$sujet,$pdf,$civilite,$nom,$prenom,$copy) {
                        ...
                        <tr>
                          <td>
                            <h1>Bonjour '.$civilite.' '.$nom.' '.$prenom.'</h1>
                						<p class="lead">Ci-joint votre rappel de facture pour votre r&eacute;servation au g&icirc;te Le Metzval.</p>
