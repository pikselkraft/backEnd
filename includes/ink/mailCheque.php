...
function envoiCheque($email,$info1,$info2,$info3,$info4) // fonction qui g&eacute;n&eacute;re un nouveau mot de passe
{
	global $mysqli;
	$info3 = date('d/m/Y',strtotime($info3));
	$info4 = date('d/m/Y',strtotime($info4));
	if(isset($email)) {
		 ...
		 */
		 ...
		 $sqlVerifExistant 	= "SELECT civilite, nom, prenom, email,mp, idclient from CLIENTS WHERE email ='".$email."'" ; //verif mail unique
      ...
      $prenom   = $row['prenom'];		
			...
			TemplateCheque($email, "Gite LeMetzval - Confirmation de votre reservation par cheque",$idclient,$civilite,$nom,$prenom,$info1,$info2,$info3,$info4);
			return true;
		 }
		 else
		 {
...
function TemplateCheque($destinataire,$sujet,$idclient,$civilite,$nom,$prenom,$info1,$info2,$info3,$info4,$copy) {
                        ...
                        <tr>
                          <td>
                            <h1>Bonjour '.$civilite.' '.$nom.' '.$prenom.'</h1>
                						<p class="lead">Votre r&eacute;servation a bien &eacute;t&eacute; prise en compte.</p>
                          				<p>Une fois votre ch&egrave;que re&ccedil;u, votre r&eacute;servation sera valid&eacute;e.</p>
                          				...
                          				<ul>
                          					...
                          					<li>Vous devez r&eacute;gler la somme de : '.$info2.' &euro;</li>
                          					<li>Vous avez r&eacute;serv&eacute; du '.$info3. ' au '.$info4.' ;</li>
                  ...
                  <tr>
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td class="panel">
                            <p>Visitez notre site pour d&eacute;couvrir les r&eacute;gions Alsace et les Vosges<a href="http://www.gite-lemetzval.fr/"> Le Metzval! </a></p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td align="center">
                            <center>
                              <p style="text-align:center;"><a href="#">Termes</a> | <a href="#">Vie priv&eacute;e</a> | <a href="http://www.gite-lemetzval.fr/wp/?page_id=274&idclient='.$idclient.'">D&eacute;sabonnement</a></p>
                            </center>
                          </td>
                          <td class="expander"></td>
                        </tr>
