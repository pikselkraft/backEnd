 ...
 */
define ('PDF_HEADER_LOGO', 'metzval-logo.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Gîte Le Metzval');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Gîte Le Metzval');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Gîte Le Metzval');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Facture");
